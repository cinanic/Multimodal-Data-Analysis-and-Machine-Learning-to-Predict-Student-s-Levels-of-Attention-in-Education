...
class Fixation:
    ...
    def __init__(self, data, media_offset = (0, 0)):
        ...
        if self.mappedfixationpointx is None or self.mappedfixationpointy is None:
            warn("A fixation with invalid coordinates. Fix="+str(self.fixationindex)+ "X="+str(self.mappedfixationpointx)+ "Y="+str(self.mappedfixationpointy) )
        else:
